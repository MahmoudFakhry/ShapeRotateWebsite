...
var button_pressed_total = 0;
var button_pressed = 0;

function setup() {
  let col_1 = color(28, 3, 29); // Button's background color.
  let col_2 = color("white"); // Button's text color.
  ...
  button.style("font-family", "Walter Turncoat");
  button.style('background-color', col_1);
  button.style("color", col_2);
  button.position(wide_half + 180, 3);
  button.mousePressed(resetup);
...
function draw() {
  ...
  if (round_player_score == 8) {
    console.log("WHATTEHF");
    draw();
  }
  ...
  */
  ...
  beginShape();
  vertex(wide_half + 180, 2);
  vertex(wide_half + 180 + 110, 2);
  vertex(wide_half + 180 + 110, 171);
  vertex(wide_half + 180, 171);
  ...
  if (vertices == 5) {
    ...
    for (let num = 0; num < 8; num++) {
      if (num == 0) {
        ...
        if (reflect_5_3 == 0) { // Reflect shape if reflect value == 1
          X1_new *= -1;
          X2_new *= -1;
          X3_new *= -1;
          X4_new *= -1;
        ...
        vertex(wide - X1_new, Y1_new + 175);
        vertex(wide - X2_new, Y2_new + 175);
        vertex(wide - X3_new, Y3_new + 175);
        vertex(wide - X4_new, Y4_new + 175);
        vertex(wide - X5_new, Y5_new + 175);
        ...
        if (reflect_5_5 == 0) { // Reflect shape if reflect value == 1
          X1_new *= -1;
          X2_new *= -1;
          X3_new *= -1;
          X4_new *= -1;
        ...
        vertex(wide - X1_new, Y1_new + 525);
        vertex(wide - X2_new, Y2_new + 525);
        vertex(wide - X3_new, Y3_new + 525);
        vertex(wide - X4_new, Y4_new + 525);
        vertex(wide - X5_new, Y5_new + 525);
        ...
        if (reflect_5_6 == 0) { // Reflect shape if reflect value == 1
          X1_new *= -1;
          X2_new *= -1;
          X3_new *= -1;
          X4_new *= -1;
        ...
        if (reflect_5_7 == 0) { // Reflect shape if reflect value == 1
          X1_new *= -1;
          X2_new *= -1;
          X3_new *= -1;
          X4_new *= -1;
    ...
    for (let num = 0; num < 8; num++) {
      if (num == 0) {
        ...
        if (reflect_6_3 == 0) { // Reflect shape if reflect value == 1
          X1_new *= -1;
          X2_new *= -1;
          X3_new *= -1;
          X4_new *= -1;
        ...
        if (reflect_6_5 == 0) { // Reflect shape if reflect value == 1
          X1_new *= -1;
          X2_new *= -1;
          X3_new *= -1;
          X4_new *= -1;
        ...
        if (reflect_6_6 == 0) { // Reflect shape if reflect value == 1
          X1_new *= -1;
          X2_new *= -1;
          X3_new *= -1;
          X4_new *= -1;
        ...
        if (reflect_6_7 == 0) { // Reflect shape if reflect value == 1
          X1_new *= -1;
          X2_new *= -1;
          X3_new *= -1;
          X4_new *= -1;
    ...
    for (let num = 0; num < 8; num++) {
      if (num == 0) {
        ...
        if (reflect_7_3 == 0) { // Reflect shape if reflect value == 1
          X1_new *= -1;
          X2_new *= -1;
          X3_new *= -1;
          X4_new *= -1;
        ...
        if (reflect_7_5 == 0) { // Reflect shape if reflect value == 1
          X1_new *= -1;
          X2_new *= -1;
          X3_new *= -1;
          X4_new *= -1;
        ...
        if (reflect_7_6 == 0) { // Reflect shape if reflect value == 1
          X1_new *= -1;
          X2_new *= -1;
          X3_new *= -1;
          X4_new *= -1;
        ...
        if (reflect_7_7 == 0) { // Reflect shape if reflect value == 1
          X1_new *= -1;
          X2_new *= -1;
          X3_new *= -1;
          X4_new *= -1;
    ...
    for (let num = 0; num < 8; num++) {
      if (num == 0) {
        ...
        if (reflect_8_3 == 0) { // Reflect shape if reflect value == 1
          X1_new *= -1;
          X2_new *= -1;
          X3_new *= -1;
          X4_new *= -1;
        ...
        if (reflect_8_5 == 0) { // Reflect shape if reflect value == 1
          X1_new *= -1;
          X2_new *= -1;
          X3_new *= -1;
          X4_new *= -1;
        ...
        if (reflect_8_6 == 0) { // Reflect shape if reflect value == 1
          X1_new *= -1;
          X2_new *= -1;
          X3_new *= -1;
          X4_new *= -1;
        ...
        if (reflect_8_7 == 0) { // Reflect shape if reflect value == 1
          X1_new *= -1;
          X2_new *= -1;
          X3_new *= -1;
          X4_new *= -1;
...
var total_possible_score = 8; // Total possible score increases by 8 for each shape.
//var player_score = 0;
...
// Variables to check if button was already pressed. 
...
function ResetButtonPress() {
  ...
  // Resets whether button has been pressed
  // once the player goes to "next" page. 
  pressable_button_v5_0 = 0;
  pressable_button_v5_1 = 0;
  pressable_button_v5_2 = 0;
  pressable_button_v5_3 = 0;
  pressable_button_v5_4 = 0;
  pressable_button_v5_5 = 0;
  pressable_button_v5_6 = 0;
  pressable_button_v5_7 = 0;

  pressable_button_v6_0 = 0;
  pressable_button_v6_1 = 0;
  pressable_button_v6_2 = 0;
  pressable_button_v6_3 = 0;
  pressable_button_v6_4 = 0;
  pressable_button_v6_5 = 0;
  pressable_button_v6_6 = 0;
  pressable_button_v6_7 = 0;

  pressable_button_v7_0 = 0;
  pressable_button_v7_1 = 0;
  pressable_button_v7_2 = 0;
  pressable_button_v7_3 = 0;
  pressable_button_v7_4 = 0;
  pressable_button_v7_5 = 0;
  pressable_button_v7_6 = 0;
  pressable_button_v7_7 = 0;

  pressable_button_v8_0 = 0;
  pressable_button_v8_1 = 0;
  pressable_button_v8_2 = 0;
  pressable_button_v8_3 = 0;
  pressable_button_v8_4 = 0;
  pressable_button_v8_5 = 0;
  pressable_button_v8_6 = 0;
...
function MouseCoords(event) {
  ...
  if (vertices == 5) {
   ...
   // first_round++; // No longer reset score to 8. 
    ...
    if ((mouseX >= wide - wide_quarter - 175) && (mouseX <= wide - wide_quarter) && (mouseY >= 175) && (mouseY <= 350) && (reflect_5_6 == 0) && (pressable_button_v5_4 == 0)) {
      beginShape();
      vertex(wide - wide_quarter, 175);
      vertex(wide - wide_quarter, 350);
      vertex(wide - wide_quarter - 175, 350);
    ...
    } else if ((mouseX >= wide - wide_quarter - 175) && (mouseX <= wide - wide_quarter) && (mouseY >= 175) && (mouseY <= 350) && (reflect_5_6 == 1) && (pressable_button_v5_4 == 0)) {
    ...
    if ((mouseX >= wide - wide_quarter - 175) && (mouseX <= wide - wide_quarter) && (mouseY >= 525) && (mouseY <= 700) && (reflect_5_7 == 0) && (pressable_button_v5_5 == 0)) {
      beginShape();
      vertex(wide - wide_quarter, 525);
      vertex(wide - wide_quarter, 700);
      vertex(wide - wide_quarter - 175, 700);
    ...
    } else if ((mouseX >= wide - wide_quarter - 175) && (mouseX <= wide - wide_quarter) && (mouseY >= 525) && (mouseY <= 700) && (reflect_5_7 == 1) && (pressable_button_v5_5 == 0)) {
    ...
    */
    ...
    if ((mouseX >= wide - wide_quarter - 175) && (mouseX <= wide - wide_quarter) && (mouseY >= 175) && (mouseY <= 350) && (reflect_6_6 == 0) && (pressable_button_v6_4 == 0)) {
      beginShape();
      vertex(wide - wide_quarter, 175);
      vertex(wide - wide_quarter, 350);
      vertex(wide - wide_quarter - 175, 350);
    ...
    } else if ((mouseX >= wide - wide_quarter - 175) && (mouseX <= wide - wide_quarter) && (mouseY >= 175) && (mouseY <= 350) && (reflect_6_6 == 1) && (pressable_button_v6_4 == 0)) {
    ...
    if ((mouseX >= wide - wide_quarter - 175) && (mouseX <= wide - wide_quarter) && (mouseY >= 525) && (mouseY <= 700) && (reflect_6_7 == 0) && (pressable_button_v6_5 == 0)) {
      beginShape();
      vertex(wide - wide_quarter, 525);
      vertex(wide - wide_quarter, 700);
      vertex(wide - wide_quarter - 175, 700);
    ...
    } else if ((mouseX >= wide - wide_quarter - 175) && (mouseX <= wide - wide_quarter) && (mouseY >= 525) && (mouseY <= 700) && (reflect_6_7 == 1) && (pressable_button_v6_5 == 0)) {
    ...
    if ((mouseX >= wide - wide_quarter - 175) && (mouseX <= wide - wide_quarter) && (mouseY >= 175) && (mouseY <= 350) && (reflect_7_6 == 0) && (pressable_button_v7_4 == 0)) {
      beginShape();
      vertex(wide - wide_quarter, 175);
      vertex(wide - wide_quarter, 350);
      vertex(wide - wide_quarter - 175, 350);
    ...
    } else if ((mouseX >= wide - wide_quarter - 175) && (mouseX <= wide - wide_quarter) && (mouseY >= 175) && (mouseY <= 350) && (reflect_7_6 == 1) && (pressable_button_v7_4 == 0)) {
    ...
    if ((mouseX >= wide - wide_quarter - 175) && (mouseX <= wide - wide_quarter) && (mouseY >= 525) && (mouseY <= 700) && (reflect_7_7 == 0) && (pressable_button_v7_5 == 0)) {
      beginShape();
      vertex(wide - wide_quarter, 525);
      vertex(wide - wide_quarter, 700);
      vertex(wide - wide_quarter - 175, 700);
    ...
    } else if ((mouseX >= wide - wide_quarter - 175) && (mouseX <= wide - wide_quarter) && (mouseY >= 525) && (mouseY <= 700) && (reflect_7_7 == 1) && (pressable_button_v7_5 == 0)) {
    ...
    if ((mouseX >= wide - wide_quarter - 175) && (mouseX <= wide - wide_quarter) && (mouseY >= 175) && (mouseY <= 350) && (reflect_8_6 == 0) && (pressable_button_v8_4 == 0)) {
      beginShape();
      vertex(wide - wide_quarter, 175);
      vertex(wide - wide_quarter, 350);
      vertex(wide - wide_quarter - 175, 350);
    ...
    } else if ((mouseX >= wide - wide_quarter - 175) && (mouseX <= wide - wide_quarter) && (mouseY >= 175) && (mouseY <= 350) && (reflect_8_6 == 1) && (pressable_button_v8_4 == 0)) {
    ...
    if ((mouseX >= wide - wide_quarter - 175) && (mouseX <= wide - wide_quarter) && (mouseY >= 525) && (mouseY <= 700) && (reflect_8_7 == 0) && (pressable_button_v8_5 == 0)) {
      beginShape();
      vertex(wide - wide_quarter, 525);
      vertex(wide - wide_quarter, 700);
      vertex(wide - wide_quarter - 175, 700);
    ...
    } else if ((mouseX >= wide - wide_quarter - 175) && (mouseX <= wide - wide_quarter) && (mouseY >= 525) && (mouseY <= 700) && (reflect_8_7 == 1) && (pressable_button_v8_5 == 0)) {
  ...
  if (round_player_score == 8) {
    console.log("WHATTEHF");
    draw(); // REPLACE WITH FUNCTION THAT RESETS ALL RELEVANT VALUES.
  }
  */

}

// First, the score will hold true values, then there will be correct (negative) values stored. 
// Second, the score will hold false values, then there will be incorrect (neutral) values stored, which become negative when clicked. 

// When the total *possible* score is found for first page, when next button is pressed, add the next possible score (ex: 8, 16, 24, etc.) 
// Meanwhile, add up values of player's score during current round. Once added, the values will be shown to screen in the form of fraction. 
// Finally, once 20 pages has been shown (160 total questions), or when the time limit (10 min) runs out (Time Crunch Mode), calculate then print percent score.

// When the score board shows up on screen, this means the game has ended. However, once the play has ended, the website presents button "Play Again" in green text, green transparent box, and green outline.

// Important: The end of the timer will automatically show the title screen, but it will not end the program. Print message to the user that game is over. 
// Once game is over, message will show to screen. Possible leaderboard screen? 
...
function KeepScore() {
  ...
  */
  ...
  if (vertices == 5) {
    const arr_reflect_5 = [reflect_5_0, reflect_5_1, reflect_5_2, reflect_5_3, reflect_5_4, reflect_5_5, reflect_5_6, reflect_5_7];
    ...
    const arr_reflect_6 = [reflect_6_0, reflect_6_1, reflect_6_2, reflect_6_3, reflect_6_4, reflect_6_5, reflect_6_6, reflect_6_7];
    ...
    const arr_reflect_7 = [reflect_7_0, reflect_7_1, reflect_7_2, reflect_7_3, reflect_7_4, reflect_7_5, reflect_7_6, reflect_7_7];
    ...
    const arr_reflect_8 = [reflect_8_0, reflect_8_1, reflect_8_2, reflect_8_3, reflect_8_4, reflect_8_5, reflect_8_6, reflect_8_7];
  ...
  console.log("total_true", total_true);
  console.log("total_false", total_false);
  ...
  // Number of mistakes:
  num_mistakes = incorrect_choice + (correct_choice - total_true);
...
function color_swap() {
  var color_type = calc_coords(0, 19); // Randomly generates number 0-19 for corresponding color.
  if (color_type == 0) {
    canvas.background(35, 1, 44);
  } else if (color_type == 1) {
    canvas.background(44, 1, 38);
  } else if (color_type == 2) {
    canvas.background(44, 1, 14);
  } else if (color_type == 3) {
    canvas.background(1, 44, 32);
  } else if (color_type == 4) {
    canvas.background(2, 2, 24);
  } else if (color_type == 4) {
    canvas.background(2, 2, 24);
  } else if (color_type == 5) {
    canvas.background(44, 36, 1);
  } else if (color_type == 6) {
    canvas.background(42, 44, 1);
  } else if (color_type == 7) {
    canvas.background(66, 2, 8);
  } else if (color_type == 8) {
    canvas.background(3, 16, 51);
  } else if (color_type == 9) {
    canvas.background(3, 58, 58);
  } else if (color_type == 10) {
    canvas.background(61, 7, 53);
  } else if (color_type == 11) {
    canvas.background(7, 32, 61);
  } else if (color_type == 12) {
    canvas.background(28, 7, 54);
  } else if (color_type == 13) {
    canvas.background(7, 37, 54);
  } else if (color_type == 14) {
    canvas.background(21, 73, 68);
  } else if (color_type == 15) {
    canvas.background(61, 18, 75);
  } else if (color_type == 16) {
    canvas.background(24, 66, 63);
  } else if (color_type == 17) {
    canvas.background(19, 68, 61);
  } else if (color_type == 18) {
    canvas.background(54, 12, 19);
  } else if (color_type == 19) {
    canvas.background(51, 12, 54);
  }
}
...
function resetup() {
  ...
  console.log("HELLOO round_player_score", round_player_score);
